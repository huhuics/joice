...
<head>
  ...
  <link rel="stylesheet" href="${ctx}/static/css/skin-blue.min.css">
...
<!-- Bootstrap 3.3.7 -->
<script src="${ctx}/static/javascript/bootstrap.min.js"></script>
<!-- AdminLTE App -->
<script src="${ctx}/static/javascript/adminlte.min.js"></script>
